...
const ZH = {
  ...
  compare_share_generating: '生成中...',
  compare_share_copy_success: '对比图片已复制到剪贴板，可直接粘贴发送！',
  compare_share_download_success: '对比图片已下载，可直接发送给朋友！',
  compare_share_fail: '生成对比图片失败，请重试',
  ...
  hot_reports_title: '📊 热门深度报告',
  hot_reports_subtitle: '最受欢迎的专业深度分析报告',
  view_all_reports: '查看全部报告 →',
  report_unlocks: '次解锁',
  report_read_btn: '阅读报告 →',
  welcome_new_user: '欢迎加入专业星图！新用户赠送3点积分，完成测评发现最适合你的专业',
  email_prompt_title: '📬 订阅专业动态？',
  email_prompt_desc: '我们会偶尔发送与你匹配专业相关的就业趋势和深度报告更新',
  email_prompt_yes: '👍 好的',
  email_prompt_no: '暂时不用',
  email_prompt_subscribed: '已订阅！有新动态会邮件通知你',
};
...
const EN = {
  ...
  compare_share_generating: 'Generating...',
  compare_share_copy_success: 'Comparison card copied to clipboard! Paste to share',
  compare_share_download_success: 'Comparison card downloaded! Send it to your friends',
  compare_share_fail: 'Failed to generate comparison card, please retry',
  ...
  hot_reports_title: '📊 Popular In-Depth Reports',
  hot_reports_subtitle: 'Most popular in-depth major analysis reports',
  view_all_reports: 'View All Reports →',
  report_unlocks: 'unlocks',
  report_read_btn: 'Read Report →',
  welcome_new_user: 'Welcome to StarMap! You got 3 free points — take the assessment to discover your best major match',
  email_prompt_title: '📬 Stay Updated?',
  email_prompt_desc: "We'll occasionally send career trends and in-depth report updates for your matched majors",
  email_prompt_yes: '👍 Yes!',
  email_prompt_no: 'Not now',
  email_prompt_subscribed: "Subscribed! We'll email you when there are updates",
};
