...
economics_majors = [
    {
        ...
        "top_universities": {"domestic": ["中国人民大学", "上海财经大学", "对外经济贸易大学", "首都经济贸易大学"], "international": ["LSE", "University of Chicago", "NYU"]}
    },
    {
        "code": "020304T",
        "name": "投资学",
        ...
        "top_universities": {"domestic": ["中央财经大学", "上海财经大学", "对外经济贸易大学", "南开大学"], "international": ["Columbia", "LSE", "Princeton"]}
    },
    {
        "code": "020306T",
        "name": "精算学",
        ...
        "what_you_learn": "精算数学、保险精算学、利息理论、风险理论、生命表理论、金融数学、数理统计、随机过程、投资与资产管理",
        "suitable_for": "数学基础极其扎实、对风险评估感兴趣的学生。",
        "career_outlook": "保险行业和金融行业发展，精算师需求稳定增长。就业主要在保险公司、精算咨询公司、银行、养老金公司等。",
        "xuefeng_comment": "精算学是数学和金融的交叉学科，被称为金领中的金领。但我要提醒大家，精算师考证难度极大，需要通过一系列国际精算师考试才能成为真正的精算师。这个专业对数学要求极高，不是简单算数那么简单。建议数学竞赛获奖者或数学天赋极强的学生报考。就业稳定，薪资待遇优厚，但需要持续学习和考证。",
        "yearly_courses": {"大一": ["微积分", "线性代数", "概率论", "政治经济学", "会计学"], "大二": ["数理统计", "利息理论", "金融学", "保险学原理"], "大三": ["精算数学", "风险理论", "生命表理论", "非寿险精算"], "大四": ["精算实习"]},
        "top_universities": {"domestic": ["对外经济贸易大学", "上海财经大学", "中央财经大学", "南开大学", "湖南大学"], "international": ["University of Waterloo", "Heriot-Watt University", "University of Michigan"]}
    },
    {
        "code": "020307T",
        "name": "数字经济",
        ...
        "top_universities": {"domestic": ["中国人民大学", "复旦大学", "浙江大学", "上海对外经贸大学"], "international": ["MIT", "Stanford", "University of Cambridge"]}
    },
    {
        "code": "120103",
        "name": "工程管理",
        ...
        "top_universities": {"domestic": ["重庆大学", "西安建筑科技大学", "同济大学", "东南大学", "天津大学"], "international": ["MIT", "Imperial College London", "TU Delft"]}
    }
]
