    ...
    card = f'''
        <div class="major-card" id="card-{code}" data-category="{category}" onclick="toggleCard('{code}')">
            ...
            <div class="detail-section hidden">
                ...
                <div class="pros-cons">
                    <div class="pros-box">
                        <strong style="color:#38ef7d;">✅ 优势分析：</strong>
                        <ul style="padding-left:15px;margin-top:8px;">{pros_list}</ul>
                    </div>
                    <div class="cons-box">
                        <strong style="color:#f5576c;">❌ 劣势分析：</strong>
                        <ul style="padding-left:15px;margin-top:8px;">{cons_list}</ul>
                    </div>
                </div>
