...
TEST_MAJORS = [
    {
        ...
        "name": "计算机科学与技术",
        "category": "08 工学",
        "description": "研究计算机系统设计、软件开发、算法原理及硬件与软件协同工作的学科",
        "courses": "高等数学、线性代数、离散数学、数据结构、算法分析、操作系统、计算机网络、数据库系统原理、编译原理、软件工程、计算机组成原理",
        "employment": "软件工程师、算法工程师、产品经理、数据分析师、系统架构师、运维工程师"
    },
    {
        "code": "100201",
        "name": "临床医学",
    ...
    },
    {
        ...
        "name": "法学",
        "category": "03 法学",
        "description": "研究法律现象、法律规范和法律实践的学科",
        "courses": "法理学、宪法学、中国法制史、民法学、商法学、知识产权法、经济法、刑法学、民事诉讼法、刑事诉讼法、行政法与行政诉讼法",
        "employment": "律师、法官、检察官、企业法务、公务员、法律教学"
    },
    {
        "code": "050301",
        "name": "新闻学",
    ...
    },
    {
        ...
        "name": "金融学",
        "category": "02 经济学",
        "description": "研究货币、金融市场、金融机构及金融政策的学科",
        "courses": "政治经济学、微观经济学、宏观经济学、货币银行学、国际金融、证券投资学、公司金融、金融工程、保险学、财政学",
        "employment": "银行、证券、基金、保险、信托、金融监管、企业财务"
    }
]
...
def generate_single_report(major, llm_client, index):
    ...
    print(f"\n{'='*80}")
    print(f"[{index}/5] 正在生成报告：{major_name} ({major_code})")
    print(f"{'='*80}")
...
现在，请开始生成完整的专业分析报告："""
    ...
    try:
        report_content = llm_client.generate(prompt, temperature=0.7, max_tokens=6000)
